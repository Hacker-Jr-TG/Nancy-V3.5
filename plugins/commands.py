...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                ...
                InlineKeyboardButton('🎭 ɢʀᴏᴜᴘ', url='https://t.me/+kQkzIFrqYj5mMjRl'),
            ],
            [
        ...
        await client.send_sticker(chat_id=message.chat.id, sticker='CAACAgUAAxkBAAEGCfliUTq0TTlmkkRZQkkxVsXnuUHrkQACQwYAAiNYiFaVWLTwRVV6cx4E', reply_markup=reply_markup, reply_to_message_id=message.message_id)
    ...
    if len(message.command) != 2:
        ...
        m=await message.reply_sticker("CAACAgUAAxkBAAEGBxNiUGaWMujpYoqubwPy7wPXOioepgACSwUAAlI5gVae60Vtw5nZqh4E")
